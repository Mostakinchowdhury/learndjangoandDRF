...
➤ Required ও Optional Part: | Argument | প্রয়োজনীয়? | ব্যাখ্যা | | ------------ | ---------- |
---------------------------------------------------------------------------------------------- | |
`model` | ✅ Required | কোন Model টাকে admin প্যানেলে রেজিস্টার করছো | | `modeladmin` | ❌ Optional
| ওই মডেলের জন্য কাস্টম `ModelAdmin` ক্লাস দিলে এটা দিতে হয়, না দিলে default settings ব্যবহার হয় |
